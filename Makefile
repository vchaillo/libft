...
#    Updated: 2016/12/16 18:49:44 by valentinchaillou89###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
clean:
		@$(RM) $(OBJ)
		@$(RM) $(OBJ_FOLDER)
		@echo "$(SILENT_COLOR)Libft - Cleaning object files$(NO_COLOR)"

fclean:	clean
		@echo "$(SILENT_COLOR)Libft - Cleaning library$(NO_COLOR)"
		@$(RM) $(NAME)
